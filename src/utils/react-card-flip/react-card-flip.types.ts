export type ReactFlipCardStyle = Record<string, any>
...
export interface ReactFlipCardProps {
   ...
   * @default {}
   */
  containerStyle?: ReactFlipCardStyle
  /**
  ...
  isFlipped?: boolean
  /**
   * The speed of the flip animation when the card flips from back to front,
   * the higher the number the slower the flip animation
   * @default 0.6
   */
  flipSpeedBackToFront?: number
  /**
   * The speed of the flip animation when the card flips from front to back,
   * the higher the number the slower the flip animation
   * @default 0.6
   */
  flipSpeedFrontToBack?: number

  cardStyles?: { front?: ReactFlipCardStyle; back?: ReactFlipCardStyle }
  /**
